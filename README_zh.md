...
[![CI](https://github.com/twn39/yt-dlp-qt-gui/actions/workflows/ci.yml/badge.svg)](https://github.com/twn39/yt-dlp-qt-gui/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/twn39/yt-dlp-qt-gui/branch/main/graph/badge.svg)](https://codecov.io/gh/twn39/yt-dlp-qt-gui)
...
-   Python 3.12 或更高版本
-   uv (推荐的包管理器)
-   **FFmpeg** (用于音视频合并，必须安装并添加到系统环境变量)
-   **Deno** (用于 YouTube 视频提取，推荐安装以支持更多 YouTube 格式)
...
-   确认 URL 是否正确且可访问
-   检查网络连接是否正常
-   确认已安装 **Deno** (YouTube 下载必需)
-   确认已安装 **FFmpeg** (音视频合并必需)
-   尝试使用代理解决网络限制
-   查看日志输出了解具体错误信息

### Q: FFmpeg 和 Deno 是必须的吗？

A: 是的。**FFmpeg** 用于音视频合并，**Deno** (或其它 JS 运行时) 用于 YouTube 视频提取。如果未安装，某些视频格式可能无法正常下载。
